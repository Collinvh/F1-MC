        ...
        if (sender instanceof Player) {
            ...
            if (player != null) {
                if (player.getWorld() == loc1.getWorld()) {
                    ...
                    if(kart == null) {
                        sender.sendMessage( serverPrefix + "Golf kar is uitgeschakeld");
                        return false;
                    }
                        ...
                        if (args.length > 0) {
                            switch (args[0].toLowerCase()) {
                                ...
                                case "despawn":
                                    ...
                                    sender.sendMessage(serverPrefix + "Golfkart gedespawned.");
                                    return true;
                            }
                        } else {
                            if (team.getGolfcooldown() <= 0) {
                                if (sender.hasPermission("projectr.spawngolf")) {
                                    if (team.getGolfKart() != null) {
                                        team.getGolfKart().despawn(true);
                                    }
                                    ...
                                    if (vehicle != null) {
                                        ...
                                        sender.sendMessage(serverPrefix + "Golfkart gespawned.");
                                ...
                                sender.sendMessage(serverPrefix + "Golfkart is op cooldown.");
                            }
                        }
                    }
                }
            } else {
                sender.sendMessage(serverPrefix + "Je zit niet in een team?");
            }
            return true;
        }
        return false;
