package collinvht.projectr.listener.driver;
        ...
        taskIds.put(driver.getPlayerUUID(), new BukkitRunnable() {
            ...
            public void run() {
                if (RaceManager.getRunningRace() != null) {
                    ...
                    if (driver.isDriving() && manager != null) {
                        Scoreboard scoreboard = manager.getNewScoreboard();

                        Objective o = scoreboard.registerNewObjective("projectr", "raceBoard");

                        o.setDisplayName("" + ChatColor.WHITE + ChatColor.BOLD + "Project" + ChatColor.YELLOW + ChatColor.BOLD + "R");
