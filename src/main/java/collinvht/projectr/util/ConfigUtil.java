...
import collinvht.projectr.util.objs.TyreConfigData;
...
public class ConfigUtil {
    ...
    private static JsonObject createDefaultConfig() {
        File config = Paths.get(ProjectR.getRacing().getDataFolder() + "/config" + ".json").toFile();
        if(!config.exists()) {
    ...
    public static void loadConfig() {
        ...
        if(object != null) {
            ...
            Bukkit.getPluginManager().disablePlugin(ProjectR.getRacing());
        }
    }
    ...
    public static void save() {
        File config = Paths.get(ProjectR.getRacing().getDataFolder().toString() + "/config" + ".json").toFile();
        JsonObject configMain = new JsonObject();
