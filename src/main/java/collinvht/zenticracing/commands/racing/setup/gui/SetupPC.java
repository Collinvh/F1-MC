package collinvht.zenticracing.commands.racing.setup.gui;

import collinvht.zenticracing.ZenticRacing;
import collinvht.zenticracing.commands.racing.setup.SetupManager;
import collinvht.zenticracing.commands.racing.setup.obj.LimitedFloat;
import collinvht.zenticracing.commands.racing.setup.obj.LimitedInteger;
...
public class SetupPC {
    ...
    private static void runTyre(HumanEntity player, LimitedFloat limitedFloat, String info) {
        ...
        }.runTaskTimer(ZenticRacing.getRacing(), 10, 1);
    }
